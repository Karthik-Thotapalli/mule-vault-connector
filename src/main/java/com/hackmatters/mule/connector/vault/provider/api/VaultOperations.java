...
import com.hackmatters.mule.connector.vault.provider.api.connection.VaultConnection;
import com.hackmatters.mule.connector.vault.provider.api.error.SecretNotFoundException;
import com.hackmatters.mule.connector.vault.provider.api.error.UnknownVaultException;
import com.hackmatters.mule.connector.vault.provider.api.error.VaultAccessException;
import com.hackmatters.mule.connector.vault.provider.api.error.VaultErrorTypeProvider;
